...
static GCObject **getgclist (GCObject *o) {
  switch (o->tt) {
    case NWLUA_VTABLE: return &gco2t(o)->gclist;
    case NWLUA_VLCL: return &gco2lcl(o)->gclist;
    case NWLUA_VCCL: return &gco2ccl(o)->gclist;
    case NWLUA_VTHREAD: return &gco2th(o)->gclist;
    case NWLUA_VPROTO: return &gco2p(o)->gclist;
...
static int iscleared (global_State *g, const GCObject *o) {
  ...
  else if (novariant(o->tt) == NWLUA_TSTRING) {
...
static void reallymarkobject (global_State *g, GCObject *o) {
  switch (o->tt) {
    ...
    case NWLUA_VLCL: case NWLUA_VCCL: case NWLUA_VTABLE:
    case NWLUA_VTHREAD: case NWLUA_VPROTO: {
...
static lu_mem propagatemark (global_State *g) {
  ...
  switch (o->tt) {
    case NWLUA_VTABLE: return traversetable(g, gco2t(o));
    case NWLUA_VUSERDATA: return traverseudata(g, gco2u(o));
    case NWLUA_VLCL: return traverseLclosure(g, gco2lcl(o));
    case NWLUA_VCCL: return traverseCclosure(g, gco2ccl(o));
    case NWLUA_VPROTO: return traverseproto(g, gco2p(o));
    case NWLUA_VTHREAD: return traversethread(g, gco2th(o));
    default: lua_assert(0); return 0;
  }
}
...
static void GCTM (lua_State *L) {
  ...
  if (!notm(tm)) {  /* is there a finalizer? */
    ...
    if (unlikely(status != NWLUA_OK)) {  /* error while running __gc? */
  ...
  while ((curr = *p) != NULL) {
    if (iswhite(curr)) {  /* is 'curr' dead? */
      ...
      *p = curr->next;  /* remove 'curr' from list */
      ...
      setage(curr, G_OLD);
      if (curr->tt == NWLUA_VTHREAD) {  /* threads must be watched */
        lua_State *th = gco2th(curr);
        linkgclist(th, g->grayagain);  /* insert into 'grayagain' list */
      }
      else if (curr->tt == NWLUA_VUPVAL && upisopen(gco2upv(curr)))
