...
namespace NW
{
	...
	public:
		...
		// --setters
		virtual void SetVariable(GfxVariables, Float32 nValue) = 0;
		virtual void SetPrimitive(GfxPrimitives gfxPrimitiveTopology) = 0;
...
namespace NW
{
	...
	public:
		...
		// --setters
		virtual void SetVariable(GfxVariables gfxVar, Float32 nValue) override;
		virtual void SetPrimitive(GfxPrimitives gfxPrimitiveTopology) override;
		...
		virtual void CreateTexture(RefKeeper<Texture>& rTexture, const char* strName, TextureTypes texType) override;
