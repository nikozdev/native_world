...
ImGuiTable* NW_GUI::TableFindByID(ImGuiID id)
{
...
bool    NW_GUI::BeginTable(const char* str_id, int columns_count, ImGuiTableFlags flags, const ImVec2& outer_size, float inner_width)
{
    ImGuiID id = GetID(str_id);
    return BeginTableEx(str_id, id, columns_count, flags, outer_size, inner_width);
}

bool    NW_GUI::BeginTableEx(const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags, const ImVec2& outer_size, float inner_width)
{
    ImGuiContext& g = *GImGui;
...
void NW_GUI::TableBeginInitMemory(ImGuiTable* table, int columns_count)
{
...
// Apply queued resizing/reordering/hiding requests
void NW_GUI::TableBeginApplyRequests(ImGuiTable* table)
{
...
static void TableSetupColumnFlags(ImGuiTable* table, ImGuiTableColumn* column, ImGuiTableColumnFlags flags_in)
{
    ...
    if (table->Flags & ImGuiTableFlags_Sortable)
    {
        ...
        NW_GUI::TableFixColumnSortDirection(table, column);
    }
}
...
void NW_GUI::TableUpdateLayout(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
void NW_GUI::TableUpdateBorders(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
void    NW_GUI::EndTable()
{
    ...
    // We have no way to prevent user submitting direct ImDrawList calls into a hidden column (but NW_GUI:: calls will be clipped out)
...
void NW_GUI::TableSetupColumn(const char* label, ImGuiTableColumnFlags flags, float init_width_or_weight, ImGuiID user_id)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
// [Public]
void NW_GUI::TableSetupScrollFreeze(int columns, int rows)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    IM_ASSERT(table != NULL && "Need to call TableSetupColumn() after BeginTable()!");
...
int NW_GUI::TableGetColumnCount()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
const char* NW_GUI::TableGetColumnName(int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
const char* NW_GUI::TableGetColumnName(const ImGuiTable* table, int column_n)
{
...
void NW_GUI::TableSetColumnEnabled(int column_n, bool enabled)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
ImGuiTableColumnFlags NW_GUI::TableGetColumnFlags(int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
ImRect NW_GUI::TableGetCellBgRect(const ImGuiTable* table, int column_n)
{
    const ImGuiTableColumn* column = &table->Columns[column_n];
...
ImGuiID NW_GUI::TableGetColumnResizeID(const ImGuiTable* table, int column_n, int instance_no)
{
    IM_ASSERT(column_n >= 0 && column_n < table->ColumnsCount);
...
int NW_GUI::TableGetHoveredColumn()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
void NW_GUI::TableSetBgColor(ImGuiTableBgTarget target, ImU32 color, int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
void NW_GUI::TableNextRow(ImGuiTableRowFlags row_flags, float row_min_height)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
void NW_GUI::TableBeginRow(ImGuiTable* table)
{
...
// [Internal] Called by TableNextRow()
void NW_GUI::TableEndRow(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
int NW_GUI::TableGetColumnIndex()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
bool NW_GUI::TableSetColumnIndex(int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
void NW_GUI::TableBeginCell(ImGuiTable* table, int column_n)
{
    ImGuiTableColumn* column = &table->Columns[column_n];
    ImGuiWindow* window = table->InnerWindow;
...
void NW_GUI::TableEndCell(ImGuiTable* table)
{
...
float NW_GUI::TableGetMaxColumnWidth(const ImGuiTable* table, int column_n)
{
    const ImGuiTableColumn* column = &table->Columns[column_n];
...
float NW_GUI::TableGetColumnWidthAuto(ImGuiTable* table, ImGuiTableColumn* column)
{
...
void NW_GUI::TableSetColumnWidth(int column_n, float width)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
void NW_GUI::TableSetColumnWidthAutoSingle(ImGuiTable* table, int column_n)
{
...
void NW_GUI::TableSetColumnWidthAutoAll(ImGuiTable* table)
{
    for (int column_n = 0; column_n < table->ColumnsCount; column_n++)
    {
        ImGuiTableColumn* column = &table->Columns[column_n];
...
void NW_GUI::TableUpdateColumnsWeightFromWidth(ImGuiTable* table)
{
...
void NW_GUI::TablePushBackgroundChannel()
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ImGuiTable* table = g.CurrentTable;
...
void NW_GUI::TablePopBackgroundChannel()
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ImGuiTable* table = g.CurrentTable;
...
void NW_GUI::TableSetupDrawChannels(ImGuiTable* table)
{
...
//   Direct ImDrawList calls won't be taken into account by default, if you use them make sure the NW_GUI:: bounds
...
void NW_GUI::TableMergeDrawChannels(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
void NW_GUI::TableDrawBorders(ImGuiTable* table)
{
    ImGuiWindow* inner_window = table->InnerWindow;
...
ImGuiTableSortSpecs* NW_GUI::TableGetSortSpecs()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    IM_ASSERT(table != NULL);
...
void NW_GUI::TableFixColumnSortDirection(ImGuiTable* table, ImGuiTableColumn* column)
{
...
ImGuiSortDirection NW_GUI::TableGetColumnNextSortDirection(ImGuiTableColumn* column)
{
...
void NW_GUI::TableSetColumnSortDirection(int column_n, ImGuiSortDirection sort_direction, bool append_to_sort_specs)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
void NW_GUI::TableSortSpecsSanitize(ImGuiTable* table)
{
...
void NW_GUI::TableSortSpecsBuild(ImGuiTable* table)
{
...
float NW_GUI::TableGetHeaderRowHeight()
{
...
void NW_GUI::TableHeadersRow()
{
    ...
    ImVec2 mouse_pos = NW_GUI::GetMousePos();
...
void NW_GUI::TableHeader(const char* label)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if (window->SkipItems)
...
void NW_GUI::TableOpenContextMenu(int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
void NW_GUI::TableDrawContextMenu(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if (window->SkipItems)
...
ImGuiTableSettings* NW_GUI::TableSettingsCreate(ImGuiID id, int columns_count)
{
    ImGuiContext& g = *GImGui;
...
ImGuiTableSettings* NW_GUI::TableSettingsFindByID(ImGuiID id)
{
...
ImGuiTableSettings* NW_GUI::TableGetBoundSettings(ImGuiTable* table)
{
...
void NW_GUI::TableResetSettings(ImGuiTable* table)
{
...
void NW_GUI::TableSaveSettings(ImGuiTable* table)
{
...
void NW_GUI::TableLoadSettings(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
static void* TableSettingsHandler_ReadOpen(ImGuiContext*, ImGuiSettingsHandler*, const char* name)
{
    ...
    if (ImGuiTableSettings* settings = NW_GUI::TableSettingsFindByID(id))
    {
    ...
    return NW_GUI::TableSettingsCreate(id, columns_count);
}
...
void NW_GUI::TableSettingsInstallHandler(ImGuiContext* context)
{
...
void NW_GUI::TableRemove(ImGuiTable* table)
{
...
void NW_GUI::TableGcCompactTransientBuffers(ImGuiTable* table)
{
...
void NW_GUI::TableGcCompactSettings()
{
    ImGuiContext& g = *GImGui;
...
void NW_GUI::DebugNodeTable(ImGuiTable* table)
{
    char buf[512];
    char* p = buf;
    const char* buf_end = buf + IM_ARRAYSIZE(buf);
    const bool is_active = (table->LastFrameActive >= NW_GUI::GetFrameCount() - 2); // Note that fully clipped early out scrolling tables will appear as inactive here.
...
void NW_GUI::DebugNodeTableSettings(ImGuiTableSettings* settings)
{
...
void NW_GUI::DebugNodeTable(ImGuiTable*) {}
void NW_GUI::DebugNodeTableSettings(ImGuiTableSettings*) {}
...
void NW_GUI::SetWindowClipRectBeforeSetChannel(ImGuiWindow* window, const ImRect& clip_rect)
{
...
int NW_GUI::GetColumnIndex()
{
    ImGuiWindow* window = GetCurrentWindowRead();
    return window->DC.CurrentColumns ? window->DC.CurrentColumns->Current : 0;
}

int NW_GUI::GetColumnsCount()
{
    ImGuiWindow* window = GetCurrentWindowRead();
    return window->DC.CurrentColumns ? window->DC.CurrentColumns->Count : 1;
}

float NW_GUI::GetColumnOffsetFromNorm(const ImGuiOldColumns* columns, float offset_norm)
{
    return offset_norm * (columns->OffMaxX - columns->OffMinX);
}

float NW_GUI::GetColumnNormFromOffset(const ImGuiOldColumns* columns, float offset)
{
...
static float GetDraggedColumnOffset(ImGuiOldColumns* columns, int column_index)
{
    ...
    x = ImMax(x, NW_GUI::GetColumnOffset(column_index - 1) + g.Style.ColumnsMinSpacing);
    if ((columns->Flags & ImGuiOldColumnFlags_NoPreserveWidths))
        x = ImMin(x, NW_GUI::GetColumnOffset(column_index + 1) - g.Style.ColumnsMinSpacing);

    return x;
}

float NW_GUI::GetColumnOffset(int column_index)
{
    ImGuiWindow* window = GetCurrentWindowRead();
...
static float GetColumnWidthEx(ImGuiOldColumns* columns, int column_index, bool before_resize = false)
{
    ...
    return NW_GUI::GetColumnOffsetFromNorm(columns, offset_norm);
}

float NW_GUI::GetColumnWidth(int column_index)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
...
void NW_GUI::SetColumnOffset(int column_index, float offset)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
...
void NW_GUI::SetColumnWidth(int column_index, float width)
{
    ImGuiWindow* window = GetCurrentWindowRead();
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
    IM_ASSERT(columns != NULL);
...
void NW_GUI::PushColumnClipRect(int column_index)
{
    ImGuiWindow* window = GetCurrentWindowRead();
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
    if (column_index < 0)
...
void NW_GUI::PushColumnsBackground()
{
    ImGuiWindow* window = GetCurrentWindowRead();
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
    if (columns->Count == 1)
...
void NW_GUI::PopColumnsBackground()
{
    ImGuiWindow* window = GetCurrentWindowRead();
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
    if (columns->Count == 1)
...
ImGuiOldColumns* NW_GUI::FindOrCreateColumns(ImGuiWindow* window, ImGuiID id)
{
...
ImGuiID NW_GUI::GetColumnsID(const char* str_id, int columns_count)
{
...
void NW_GUI::BeginColumns(const char* str_id, int columns_count, ImGuiOldColumnFlags flags)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = GetCurrentWindow();
...
void NW_GUI::Columns(int columns_count, const char* id, bool border)
{
    ImGuiWindow* window = GetCurrentWindow();
    IM_ASSERT(columns_count >= 1);
